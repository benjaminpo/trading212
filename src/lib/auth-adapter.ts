...
export function DatabaseAdapter(): Adapter {
  return {
    ...
    async getUserByAccount({
      ...
      const account = await db.findAccountByProvider(
        provider,
        providerAccountId,
      );
    ...
    async updateUser(
      ...
      return {
        ...
        emailVerified: (user.emailVerified ??
          existingUser.emailVerified) as Date | null,
    ...
    async linkAccount(account: AdapterAccount): Promise<AdapterAccount> {
      ...
      return {
        ...
        refresh_token: (newAccount.refresh_token ?? undefined) as
          | string
          | undefined,
        access_token: (newAccount.access_token ?? undefined) as
          | string
          | undefined,
        ...
        session_state: (newAccount.session_state ?? undefined) as
          | string
          | undefined,
      };
    },
