...
export type Currency = 'USD' | 'GBP' | 'EUR' | 'CAD' | 'AUD' | 'JPY' | 'CHF' | 'SEK' | 'NOK' | 'DKK' | 'PLN' | 'CZK' | 'HUF' | 'RON' | 'BGN' | 'HRK' | 'RSD' | 'MKD' | 'ALL' | 'BAM' | 'MDL' | 'UAH' | 'GEL' | 'AZN' | 'AMD' | 'KZT' | 'KGS' | 'TJS' | 'TMT' | 'UZS' | 'MNT' | 'LAK' | 'KHR' | 'VND' | 'THB' | 'MYR' | 'SGD' | 'IDR' | 'PHP' | 'BND' | 'MMK' | 'LKR' | 'BDT' | 'PKR' | 'AFN' | 'NPR' | 'BTN' | 'MVR' | 'SCR' | 'MUR' | 'KMF' | 'DJF' | 'SOS' | 'ETB' | 'ERN' | 'SDG' | 'SSP' | 'EGP' | 'LYD' | 'TND' | 'DZD' | 'MAD' | 'MRO' | 'MUR' | 'SCR' | 'KMF' | 'DJF' | 'SOS' | 'ETB' | 'ERN' | 'SDG' | 'SSP' | 'EGP' | 'LYD' | 'TND' | 'DZD' | 'MAD'
