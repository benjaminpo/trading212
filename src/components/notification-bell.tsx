...
export default function NotificationBell() {
  ...
  const handleNotificationClick = () => {
    ...
    alert(`You have ${unreadCount} unread notifications. Check the console for details.`)
  }
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <Badge 
            className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center text-xs bg-red-500 text-white border-0 p-0 min-w-[1.25rem]"
          >
