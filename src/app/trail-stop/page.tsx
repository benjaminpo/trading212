...
export default function TrailStopPage() {
      ...
      if (selectedAccountId) {
        ...
        if (accountsResponse.ok) {
          ...
          const selectedAccount = accountsData.accounts?.find(
            (acc: { id: string; isPractice: boolean }) =>
  ...
  const handleDeleteOrder = async (orderId: string) => {
    if (!confirm("Are you sure you want to delete this trail stop order?"))
      return;
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-300">
                    Automated stop-loss orders that trail the market price
                  </p>
                </div>
              </div>
                          ...
                          <div className="text-sm text-blue-700 dark:text-blue-300 mt-1 space-y-2">
                            <div>
                              ...
                              <ul className="ml-4 space-y-1">
                                <li>
                                  • Orders are executed automatically by our
                                  system
                                </li>
                                <li>
                                  • Market sell orders placed when triggered
                                </li>
                              </ul>
                            </div>
                            <div>
                              ...
                              <ul className="ml-4 space-y-1">
                                <li>
                                  • Orders trigger notifications to alert you
                                </li>
                                <li>
                                  • You manually place the sell order in
                                  Trading212
                                </li>
                                <li>
                                  • Email/app notifications when stop price is
                                  hit
                                </li>
                              </ul>
                            </div>
                            <div>
                              ...
                              <ul className="ml-4 space-y-1">
                                <li>
                                  • Stop price adjusts only when market moves
                                  favorably
                                </li>
                                <li>
                                  • Orders are monitored continuously during
                                  market hours
                                </li>
                              </ul>
                            </div>
                ...
                {orders.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100 mb-2">
                      No trail stop orders
                    </h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-4">
                      Create your first automated stop-loss order to protect
                      your positions.
                    </p>
                    <Button
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => (
                      <div
                        key={order.id}
                        className={`border rounded-lg p-4 ${order.isActive ? "border-green-200 dark:border-green-800 bg-green-50/50 dark:bg-green-950/20" : "border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50"}`}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            <div>
                              <div className="flex items-center space-x-2">
                                ...
                                <Badge
                                  variant={
                                    order.isActive ? "default" : "secondary"
                                  }
                                >
                          ...
                          <div className="flex items-center space-x-2">
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                handleToggleOrder(order.id, order.isActive)
                              }
                              className={
                                order.isActive
            ...
            <Card className="border border-blue-200/50 dark:border-blue-800/30 shadow-lg bg-blue-50/50 dark:bg-blue-950/20 backdrop-blur-sm">
              ...
              <CardContent className="text-blue-800 dark:text-blue-200 space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    A trail stop order automatically adjusts the stop price as
                    the market price moves in your favor, helping lock in
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Stock at $100, trail amount $5 → Stop price starts at $95.
                    If stock rises to $110, stop price adjusts to $105. If stock
                    falls to $105, order triggers.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-1">Account Mode Behavior:</h4>
                  <p className="text-sm">
                    <strong>Practice:</strong> Orders executed automatically.{" "}
                    <strong>Live:</strong> Notifications sent when triggered -
                    you manually execute the trade in Trading212.
                  </p>
                </div>
              </CardContent>
            </Card>
