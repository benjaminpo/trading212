        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              Take control of your Trading212 account with{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              ...
              <Link href="/auth/signin">
                <Button
                  variant="outline"
                  size="lg"
                  className="text-lg px-10 py-6 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200 w-full sm:w-auto"
                >
                  Sign In
                </Button>
              </Link>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
              ...
              <div className="text-center group">
                <div className="text-3xl font-bold text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform duration-200">
                  24/7
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Monitoring
              ...
              <div className="text-center group">
                <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-200">
                  Real-time
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Analytics
              ...
              <div className="text-center group">
                <div className="text-3xl font-bold text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-200">
                  Mobile
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  First
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="text-center group hover:shadow-2xl hover:scale-105 transition-all duration-300 border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/50 dark:to-blue-900/50 dark:shadow-2xl">
            ...
            <CardContent>
              <CardDescription className="text-gray-600 dark:text-gray-300 leading-relaxed">
                AI-powered recommendations for optimal exit strategies based on
                advanced market analysis and machine learning
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center group hover:shadow-2xl hover:scale-105 transition-all duration-300 border-0 shadow-lg bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/50 dark:to-green-900/50 dark:shadow-2xl">
            ...
            <CardContent>
              <CardDescription className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Automated trailing stop loss orders to protect your profits and
                limit losses with intelligent risk management
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center group hover:shadow-2xl hover:scale-105 transition-all duration-300 border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/50 dark:to-purple-900/50 dark:shadow-2xl">
            ...
            <CardContent>
              <CardDescription className="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                for daily, monthly, and yearly performance tracking
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="text-center group hover:shadow-2xl hover:scale-105 transition-all duration-300 border-0 shadow-lg bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/50 dark:to-orange-900/50 dark:shadow-2xl">
            ...
            <CardContent>
              <CardDescription className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Built with Capacitor for native mobile experience on iOS and
                Android with offline capabilities
              </CardDescription>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              AI technology with intuitive design to give you the edge in
              today&apos;s markets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Real-time data processing and instant trade execution. Never
                miss an opportunity with our optimized platform.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Your data and trades are protected with enterprise-level
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl mb-10 opacity-90 leading-relaxed max-w-2xl mx-auto">
            Join thousands of traders who trust Trading212 Extra for their
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                Professional trading tools for the modern investor. Powered by
                AI, designed for success. Take control of your trading journey
