...
import { PositionData, MarketData, BatchAnalysisRequest } from '../../lib/optimized-ai-service'
...
describe('OptimizedAIService - Branch Coverage', () => {
  ...
  describe('Cache operations', () => {
    it('should return cached recommendation when found in database', async () => {
      ...
      prisma.aIRecommendation.findFirst.mockResolvedValue(mockCachedRecommendation)
    ...
    it('should return null when cache lookup throws error', async () => {
      const { prisma } = require('../../lib/prisma')
      prisma.aIRecommendation.findFirst.mockRejectedValue(new Error('Database error'))
    ...
    it('should return null when cached recommendation is expired', async () => {
      ...
      prisma.aIRecommendation.findFirst.mockResolvedValue(mockExpiredRecommendation)
  ...
  describe('Response parsing', () => {
    it('should handle invalid JSON response', async () => {
      ...
      const result = await (aiService as any).parseBatchAIResponse('invalid json', mockPositions)
    ...
    it('should handle non-array JSON response', async () => {
      ...
      const result = await (aiService as any).parseBatchAIResponse('{"not": "array"}', mockPositions)
    ...
    it('should handle partial AI response with missing fields', async () => {
      ...
      const result = await (aiService as any).parseBatchAIResponse(partialResponse, mockPositions)
  ...
  describe('Cache clearing', () => {
    ...
    it('should handle cache clearing errors', async () => {
      const { prisma } = require('../../lib/prisma')
      prisma.aIRecommendation.deleteMany.mockRejectedValue(new Error('Database error'))
  ...
  describe('Utility methods', () => {
    ...
    it('should generate cache key correctly', () => {
      ...
      const cacheKey = (aiService as any).generateCacheKey(position, 'MODERATE')
