...
describe('APIBatcher - Branch Coverage', () => {
  ...
  describe('request method', () => {
    it('should return cached data when available', async () => {
      ...
      const result = await batcher.request('user1', 'acc1', 'portfolio', 'api-key', false)

      expect(result).toBe(cachedData)
      expect(mockApiCache.get).toHaveBeenCalledWith('user1', 'acc1', 'portfolio')
    })
    ...
    it('should add request to batch when not cached', async () => {
      ...
      const requestPromise = batcher.request('user1', 'acc1', 'portfolio', 'api-key', false)
  ...
  describe('executeAccountBatch', () => {
    it('should handle unknown request type', async () => {
      ...
      await (batcher as any).executeAccountBatch('acc1', requests, 'api-key', false)
    ...
    it('should handle mixed success and failure results', async () => {
      ...
      const portfolioResult = await batcher.request('user1', 'acc1', 'portfolio', 'api-key', false)
