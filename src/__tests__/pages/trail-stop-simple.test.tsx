...
describe('Trail Stop quantity input precision', () => {
  ...
  it('allows high precision quantity input like 91.20073327', async () => {
    ...
    // Find quantity input
    const quantityInput = await screen.findByPlaceholderText(/Number of shares \(e\.g\., 91\.20073327\)/)
  ...
  it('accepts various decimal precisions', async () => {
    ...
    const quantityInput = await screen.findByPlaceholderText(/Number of shares/)
