...
describe('/api/daily-pnl', () => {
  ...
  describe('GET', () => {
    ...
    it('should handle custom parameters', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/daily-pnl?accountId=acc1&days=7&startDate=2024-01-01&endDate=2024-01-07')
      const response = await GET(request)
      const data = await response.json()
  ...
  describe('POST', () => {
    ...
    it('should create new daily P/L record', async () => {
      ...
      const mockAccountData = {
        ...
        stats: { totalPnL: 1000, todayPnL: 100, totalValue: 10000, activePositions: 5 },
      }
      ...
      mockOptimizedTrading212Service.getAccountData.mockResolvedValue(mockAccountData)
    ...
    it('should handle force refresh', async () => {
      ...
      mockOptimizedTrading212Service.canMakeRequest.mockReturnValue(true)
      mockOptimizedTrading212Service.forceRefreshAccountData.mockResolvedValue(mockAccountData)
      mockPrisma.dailyPnL.findUnique.mockResolvedValue(null)
      mockPrisma.dailyPnL.create.mockResolvedValue({
        id: '1',
        userId: 'user1',
      ...
      expect(response.status).toBe(200)
      expect(mockOptimizedTrading212Service.forceRefreshAccountData).toHaveBeenCalledWith(
        'user1',
        'acc1',
        'test-key',
        false
