...
describe('/api/ai/optimized-analyze', () => {
  ...
  describe('POST', () => {
    it('should perform batch analysis for all accounts', async () => {
      const request = new NextRequest('http://localhost/api/ai/optimized-analyze', {
        method: 'POST',
    ...
    it('should return 400 when no accounts found', async () => {
      ...
      expect(data).toHaveProperty('error', 'No active Trading212 accounts found')
    })
    ...
    it('should handle service errors gracefully', async () => {
      ...
      optimizedAIService.analyzePositionsBatch.mockRejectedValue(new Error('Analysis failed'))
