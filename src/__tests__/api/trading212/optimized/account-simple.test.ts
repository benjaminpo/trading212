...
describe('Optimized Trading212 Account Route', () => {
  ...
  it('should handle unauthorized requests', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/trading212/optimized/account')
  ...
  it('should handle API service errors', async () => {
    ...
    optimizedTrading212Service.getAccount.mockRejectedValue(new Error('API error'))
