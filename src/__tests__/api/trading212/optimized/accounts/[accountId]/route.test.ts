import { PUT, DELETE } from '../../../../../../app/api/trading212/optimized/accounts/[accountId]/route'
...
describe('Trading212 Account [accountId] Route', () => {
  ...
  describe('PUT /api/trading212/optimized/accounts/[accountId]', () => {
    it('should handle unauthorized requests', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/trading212/optimized/accounts/acc1', {
        method: 'PUT',
    ...
    it('should handle duplicate account name', async () => {
      ...
      const mockExistingAccount = { id: 'acc1', name: 'Test Account', userId: 'user1' }
      const mockDuplicateAccount = { id: 'acc2', name: 'Test Account', userId: 'user1' }
    ...
    it('should update account successfully', async () => {
      ...
      const mockExistingAccount = { id: 'acc1', name: 'Old Name', userId: 'user1' }
      const mockUpdatedAccount = { id: 'acc1', name: 'New Name', isPractice: false }
      ...
      const request = new NextRequest('http://localhost:3000/api/trading212/optimized/accounts/acc1', {
        method: 'PUT',
        body: JSON.stringify({ name: 'New Name', apiKey: 'new-key', isPractice: false })
      })
  ...
  describe('DELETE /api/trading212/optimized/accounts/[accountId]', () => {
    it('should handle unauthorized requests', async () => {
      ...
      const response = await DELETE(request, { params: Promise.resolve({ accountId: 'acc1' }) })
      const data = await response.json()
    ...
    it('should handle database errors during deletion', async () => {
      ...
      getServerSession.mockResolvedValue({ user: { id: 'user1' } })
      retryDatabaseOperation
        .mockResolvedValueOnce({ id: 'acc1', name: 'Test Account', userId: 'user1' }) // Find account
