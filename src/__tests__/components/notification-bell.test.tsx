...
describe('NotificationBell', () => {
  ...
  it('should render notification bell with unread count', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith('/api/notifications?unreadOnly=true&limit=10')
  })
  ...
  it('should handle click and show notifications in console', async () => {
    ...
    expect(mockConsoleLog).toHaveBeenCalledWith('Notifications:', mockNotifications)
    expect(mockAlert).toHaveBeenCalledWith('You have 2 unread notifications. Check the console for details.')
  ...
  it('should handle API error gracefully', async () => {
    ...
    expect(mockConsoleError).toHaveBeenCalledWith('Error loading notifications:', expect.any(Error))
  })
